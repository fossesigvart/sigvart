...
export function ContactCard({
  ...
  return (
    <div
      ...
      {...props}
    >
      <PlusIcon className="absolute -top-3 -left-3 h-6 w-6 text-neutral-300" />
      <PlusIcon className="absolute -top-3 -right-3 h-6 w-6 text-neutral-300" />
      <PlusIcon className="absolute -bottom-3 -left-3 h-6 w-6 text-neutral-300" />
      <PlusIcon className="absolute -right-3 -bottom-3 h-6 w-6 text-neutral-300" />

      <div className="flex flex-col justify-between lg:col-span-2">
        <div className="relative h-full space-y-4 px-4 py-8 md:p-8">
          <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl font-[family-name:var(--font-heading)]">
            {title}
          </h1>
